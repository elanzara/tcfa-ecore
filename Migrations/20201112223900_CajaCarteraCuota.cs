...
{
    public partial class CajaCarteraCuota : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "caja_cartera_cuota",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_caja_cartera_cuota", x => x.id);
                    table.ForeignKey(
                        name: "fk_caja_cartera_cuota",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_caja_cartera_cuota_id_caja_cartera_enc",
                table: "caja_cartera_cuota",
