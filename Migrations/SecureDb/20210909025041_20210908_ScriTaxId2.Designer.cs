...
namespace eCore.Migrations.SecureDb
{
    ...
    [Migration("20210909025041_20210908_ScriTaxId2")]
    partial class _20210908_ScriTaxId2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCore.Entities.ScriCodigoProductor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("scri_codigo_productor");
                });

            modelBuilder.Entity("eCore.Entities.ScriListJobSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("IdScriMovimientos")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("IdScriMovimientos")
                        .HasColumnName("ScriListJobSummary_IdScriMovimientos");

                    b.Property<string>("OfferingPlan")
                    ...
                    b.Property<string>("PolicyPeriodID")
                    ...
                    b.Property<string>("ScopeCoverage")
                    ...
                    b.Property<string>("TransactionJob")
                    ...
                    b.HasIndex("IdScriMovimientos");

                    b.ToTable("scri_list_job_summary");
                });

            modelBuilder.Entity("eCore.Entities.ScriMessages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ErrorLevel")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("ErrorLevel")
                        .HasColumnName("ScriMessages_ErrorLevel");

                    b.Property<int>("IdScriMovimientos");

                    b.Property<string>("MessageBeautiful")
                    ...
                    b.ToTable("scri_messages");
                });

            modelBuilder.Entity("eCore.Entities.ScriMovimientos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<bool>("HasInformation")
                    ...
                    b.ToTable("scri_movimientos");
                });

            modelBuilder.Entity("eCore.Entities.ScriOffering", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("IdScriListJobSummary")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("IdScriListJobSummary")
                        .HasColumnName("ScriOffering_IdScriListJobSummary");

                    b.HasKey("Id");

                    b.HasIndex("IdScriListJobSummary");

                    b.ToTable("scri_offering");
                });

            modelBuilder.Entity("eCore.Entities.ScriPolicyType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("IdScriListJobSummary")
                    ...
                    b.Property<int>("IdScriListJobSummary")
                        .HasColumnName("ScriPolicyType_IdScriListJobSummary");

                    b.HasKey("Id");

                    b.HasIndex("IdScriListJobSummary");

                    b.ToTable("scri_policy_type");
                });

            modelBuilder.Entity("eCore.Entities.ScriProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("IdScriListJobSummary")
                    ...
                    b.Property<int>("IdScriListJobSummary")
                        .HasColumnName("ScriProduct_IdScriListJobSummary");

                    b.HasKey("Id");

                    b.HasIndex("IdScriListJobSummary");

                    b.ToTable("scri_product");
                });

            modelBuilder.Entity("eCore.Entities.ScriTaxId", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("eCore.Entities.ScriListJobSummary", b =>
                {
                    b.HasOne("eCore.Entities.ScriMovimientos", "IdScriMovimientosNavigation")
                        .WithMany("ScriListJobSummary")
                        .HasForeignKey("IdScriMovimientos")
            ...
            modelBuilder.Entity("eCore.Entities.ScriOffering", b =>
                {
                    b.HasOne("eCore.Entities.ScriListJobSummary", "IdScriListJobSummaryNavigation")
                        .WithMany("ScriOffering")
                        .HasForeignKey("IdScriListJobSummary")
