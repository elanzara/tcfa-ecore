...
{
    public class MAccGruposConfiguration : IEntityTypeConfiguration<MAccGrupos>
    {
        public void Configure(EntityTypeBuilder<MAccGrupos> builder)
        {
            builder.ToTable("m_acc_grupos");
