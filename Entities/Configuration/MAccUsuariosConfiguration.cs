...
{
    public class MAccUsuariosConfiguration : IEntityTypeConfiguration<MAccUsuarios>
    {
        public void Configure(EntityTypeBuilder<MAccUsuarios> builder)
        {
            builder.ToTable("m_acc_usuarios");
