...
{
    public class LAccPerfilesConfiguration : IEntityTypeConfiguration<LAccPerfiles>
    {
        public void Configure(EntityTypeBuilder<LAccPerfiles> builder)
        {
            builder.ToTable("l_acc_perfiles");
