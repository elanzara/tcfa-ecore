...
{
    public class NAccGruposXPerfilConfiguration : IEntityTypeConfiguration<NAccGruposXPerfil>
    {
        public void Configure(EntityTypeBuilder<NAccGruposXPerfil> builder)
        {
            builder.ToTable("n_acc_grupos_x_perfil");
