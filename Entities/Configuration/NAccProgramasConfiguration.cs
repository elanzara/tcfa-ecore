...
{
    public class NAccProgramasConfiguration : IEntityTypeConfiguration<NAccProgramas>
    {
        public void Configure(EntityTypeBuilder<NAccProgramas> builder)
        {
            builder.ToTable("n_acc_programas");
