...
{
    public class LAccUsuariosConfiguration : IEntityTypeConfiguration<LAccUsuarios>
    {
        public void Configure(EntityTypeBuilder<LAccUsuarios> builder)
        {
            builder.ToTable("l_acc_usuarios");
