...
{
    public class AccGruposConfiguration : IEntityTypeConfiguration<AccGrupos>
    {
        public void Configure(EntityTypeBuilder<AccGrupos> builder)
        {
            builder.ToTable("acc_grupos");
