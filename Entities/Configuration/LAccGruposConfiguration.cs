...
{
    public class LAccGruposConfiguration : IEntityTypeConfiguration<LAccGrupos>
    {
        public void Configure(EntityTypeBuilder<LAccGrupos> builder)
        {
            builder.ToTable("l_acc_grupos");
