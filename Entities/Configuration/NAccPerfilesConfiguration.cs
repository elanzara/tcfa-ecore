...
{
    public class NAccPerfilesConfiguration : IEntityTypeConfiguration<NAccPerfiles>
    {
        public void Configure(EntityTypeBuilder<NAccPerfiles> builder)
        {
            builder.ToTable("n_acc_perfiles");
