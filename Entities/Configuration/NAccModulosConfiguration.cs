...
{
    public class NAccModulosConfiguration : IEntityTypeConfiguration<NAccModulos>
    {
        public void Configure(EntityTypeBuilder<NAccModulos> builder)
        {
            builder.ToTable("n_acc_modulos");
