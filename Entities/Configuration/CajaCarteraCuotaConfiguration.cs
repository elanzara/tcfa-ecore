...
{
    public class CajaCarteraCuotaConfiguration : IEntityTypeConfiguration<CajaCarteraCuota>
    {
        public void Configure(EntityTypeBuilder<CajaCarteraCuota> builder)
        {
            builder.ToTable("caja_cartera_cuota");
